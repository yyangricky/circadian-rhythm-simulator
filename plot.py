...
normal_light = LightSchedule.from_pulse(150, 7, 16, 24)
all_nighter = LightSchedule.from_pulse(150, 23+5*24, 8, None)
light_values = normal_light(time) + all_nighter(time)
